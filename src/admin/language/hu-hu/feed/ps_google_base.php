...
$_['text_import']                  = 'A legfrissebb Google kategóriák lista letöltéséhez <a href="https://support.google.com/merchants/answer/160081?hl=hu" target="_blank" class="alert-link">kattintson ide</a>, és válassza a taxonómiát numerikus azonosítókkal rendelkező sima szöveg (.txt) fájlt. Ezután a letöltött fájlt töltse fel a zöld gomb segítségével.';
$_['text_authentication']          = 'Hitelesítés';
$_['text_tax_deffinitions']        = 'Adódefiníciók';
$_['text_getting_started']         = '<p><strong>Áttekintés:</strong> A "Google Base" kiterjesztés az OpenCart 4-hez lehetővé teszi a felhasználók számára, hogy termékeiket könnyedén exportálják a Google Merchant Centerbe XML formátumban. Ez az alapvető eszköz növeli a termékek láthatóságát a Google Shoppingon, megkönnyítve ezzel a potenciális vásárlók számára a termékek felfedezését és megvásárlását.</p><p><strong>Követelmények:</strong> A kiterjesztés használatához győződjön meg arról, hogy az OpenCart 4 telepítve és konfigurálva van. Emellett aktív Google Merchant Center fiók szükséges a terméklisták hatékony kezeléséhez.</p>';
$_['text_setup']                   = '<p><strong>A Google Base beállítása:</strong> A Google Base kiterjesztés beállításához kövesse az alábbi lépéseket:</p><p>1. Töltse le a legfrissebb Google kategóriák listáját a <a href="https://support.google.com/merchants/answer/160081?hl=en">Google Merchant Center Támogatás</a> oldaláról.</p><p>2. Kösse össze webshop kategóriáit a megfelelő Google kategóriákkal.</p><p>3. Állítsa be a kiterjesztést úgy, hogy kihagyja a készleten nem lévő termékeket, ha kívánja.</p><p>4. Használjon nettó árakat a feedben az adott opció engedélyezésével, és testreszabhatja az adódefiníciókat ennek megfelelően.</p>';
$_['text_troubleshot']             = '<p><strong>Problémamegoldás:</strong></p><p>Ha problémákba ütközik, vegye figyelembe az alábbi gyakori hibákat:</p><p><strong>Google kategóriák nem jelennek meg:</strong> Győződjön meg arról, hogy letöltötte a legfrissebb Google kategóriák listáját, és importálta azokat a rendszerébe. Ez elengedhetetlen a webshop és a Google Merchant Center közötti helyes térképezéshez.</p><p><strong>Nincs termék feed kimenet:</strong> Ellenőrizze, hogy a Google Base kiterjesztés engedélyezve van-e az OpenCart admin panelen. Ha engedélyezve van, és még mindig nem lát kimenetet, nézze át a kiterjesztés beállításait, hogy nincs-e hiba a konfigurációban.</p><p><strong>Termékek nem jelennek meg a Google Merchant Centerben:</strong> Ellenőrizze, hogy termékei helyesen kategorizálva vannak-e, és hogy nincsenek-e hibák a termékadataiban. Győződjön meg arról, hogy megfelel a Google Merchant Center terméklistázási irányelveinek.</p>';
$_['text_faq']                     = '<details><summary>Mi az a Google Base kiterjesztés?</summary><p>A Google Base kiterjesztés segít az OpenCart 4 felhasználóknak exportálni termékadataikat a Google Merchant Centerbe, növelve ezzel a láthatóságot a Google Shoppingon.</p></details><details><summary>Hogyan tudom engedélyezni a Google Base kiterjesztést?</summary><p>A kiterjesztést az OpenCart admin panelen, az Extensions szekció alatt tudja engedélyezni. Győződjön meg arról, hogy a beállításokat szükség szerint konfigurálta.</p></details><details><summary>Testreszabhatom a termék feedemet?</summary><p>Igen, a kiterjesztés lehetővé teszi különböző beállítások testreszabását, beleértve a nettó árak használatát és az adódefiníciókat, biztosítva ezzel, hogy a feed megfeleljen az igényeinek.</p></details><details><summary>Miért nem jelenik meg a termék feedem a Google Merchant Centerben?</summary><p>Győződjön meg arról, hogy a Google Base kiterjesztés engedélyezve van, és hogy termékkategóriái helyesen vannak társítva a Google kategóriákhoz. Ezenkívül ellenőrizze, hogy nincsenek-e hibák a feed konfigurációjában.</p></details>';
