...
$_['text_troubleshot']             = '<ul><li><strong>Категории Google не отображаются:</strong> Убедитесь, что вы скачали актуальный список категорий Google и импортировали его в свою систему. Это важно для корректного сопоставления категорий вашего магазина с Google Merchant Center.</li><li><strong>Нет вывода ленты продуктов:</strong> Проверьте, что расширение Google Product Data Feed включено в админ-панели OpenCart. Если оно включено и вывод все равно отсутствует, проверьте настройки расширения на наличие ошибок.</li><li><strong>Продукты не отображаются в Google Merchant Center:</strong> Убедитесь, что ваши товары правильно классифицированы и что в данных о товаре нет ошибок. Также убедитесь, что вы соблюдаете политику Google Merchant Center по размещению товаров.</li></ul>';
$_['text_faq']                     = '<details><summary>Что такое расширение Google Product Data Feed?</summary><p>Расширение Google Product Data Feed помогает пользователям OpenCart 4.x экспортировать данные о своих товарах в Google Merchant Center, улучшая видимость на Google Shopping.</p></details><details><summary>Как включить расширение Google Product Data Feed?</summary><p>Вы можете включить расширение в админ-панели OpenCart в разделе "Расширения". Убедитесь, что настройки настроены правильно.</p></details><details><summary>Можно ли настроить ленту продуктов?</summary><p>Да, расширение позволяет настроить различные параметры, включая использование цен до налога и определения налогов, чтобы ваша лента соответствовала вашим требованиям.</p></details><details><summary>Почему моя лента продуктов не отображается в Google Merchant Center?</summary><p>Убедитесь, что расширение Google Product Data Feed включено и что ваши категории продуктов правильно ассоциированы с категориями Google. Также проверьте настройки ленты на наличие ошибок.</p></details>';
