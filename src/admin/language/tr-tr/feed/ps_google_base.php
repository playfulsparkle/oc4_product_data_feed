...
$_['heading_setup']                = 'Google Base Kurulumu';
...
$_['text_success']                 = 'Başarılı: Google Base beslemeleri güncellendi!';
...
$_['text_gbc2c_restore']           = 'Google Base kategori ile mağaza kategori eşleştirmelerini içe aktarmadan önce, doğru mağazayı seçtiğinizden emin olun. Yüklediğiniz yedekleme dosyasının (gbc2c_backup_store_x.txt) sonunda geri yükleme yapılan mağazanın kimliği (x) bulunmalıdır.';
...
$_['help_additional_images']       = 'Bu seçeneği etkinleştirirseniz, Google Base beslemenize ek resimler eklenir. Bu ayarın etkinleştirilmesi besleme oluşturma sürecini yavaşlatabilir ve oluşturulan XML dosyasının boyutunu artırabilir.';

// Error
$_['error_permission']             = 'Uyarı: Google Base beslemesini değiştirme izniniz yok!';
