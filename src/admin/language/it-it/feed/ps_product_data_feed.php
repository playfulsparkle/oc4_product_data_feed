...
$_['text_troubleshot']             = '<ul><li><strong>Le categorie di Google non vengono visualizzate:</strong> Assicurati di aver scaricato l\'ultima lista delle categorie di Google e di averle importate nel tuo sistema. Questo è essenziale per una corretta mappatura tra il tuo negozio online e Google Merchant Center.</li><li><strong>Nessun output del feed di prodotto:</strong> Verifica che l\'estensione Google Product Data Feed sia abilitata nel pannello di amministrazione di OpenCart. Se è abilitata e non vedi ancora alcun output, controlla le impostazioni dell\'estensione per eventuali configurazioni errate.</li><li><strong>I prodotti non appaiono in Google Merchant Center:</strong> Verifica che i tuoi prodotti siano correttamente classificati e che non ci siano errori nei dati del prodotto. Assicurati di rispettare le politiche di Google Merchant Center riguardanti le inserzioni di prodotti.</li></ul>';
$_['text_faq']                     = '<details><summary>Cos\'è l\'estensione Google Product Data Feed?</summary><p>L\'estensione Google Product Data Feed aiuta gli utenti di OpenCart 4.x a esportare i dati dei loro prodotti su Google Merchant Center, aumentando la visibilità su Google Shopping.</p></details><details><summary>Come attivo l\'estensione Google Product Data Feed?</summary><p>Puoi attivare l\'estensione dal pannello di amministrazione di OpenCart nella sezione Estensioni. Assicurati di configurare le impostazioni come necessario.</p></details><details><summary>Posso personalizzare il mio feed di prodotto?</summary><p>Sì, l\'estensione ti consente di personalizzare diverse impostazioni, tra cui l\'uso dei prezzi al netto delle tasse e le definizioni fiscali, assicurando che il feed soddisfi le tue esigenze.</p></details><details><summary>Perché il mio feed di prodotto non appare in Google Merchant Center?</summary><p>Assicurati che l\'estensione Google Product Data Feed sia abilitata e che le categorie dei tuoi prodotti siano correttamente associate alle categorie di Google. Inoltre, verifica eventuali errori nella configurazione del feed.</p></details>';
